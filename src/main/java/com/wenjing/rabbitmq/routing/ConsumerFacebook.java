...
public class ConsumerFacebook {
    public static void main(String[] args) throws IOException {
        ...
        channel.queueBind(RabbitConstraint.QUEUE_FACEBOOK, RabbitConstraint.EXCHANGE_WEATHER_ROUTING, "US,Chicago,20220821");
        channel.queueBind(RabbitConstraint.QUEUE_FACEBOOK, RabbitConstraint.EXCHANGE_WEATHER_ROUTING, "US,Chicago,20220822");
        channel.basicQos(1);
